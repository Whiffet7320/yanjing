<template>
  <div class="hyindex">
    ...
    <div class="right">
      ...
      <template v-if="radioVal2 == '手动输入'">
        <div class="nav3">
          <div class="nav3-1">
            ...
            <div class="txt1 color">
              编号,姓名,电话,地址按顺序填写,中间用逗号分隔。一次可以输入多个收件人信息，一个收件人信息一行输入。
            </div>
            <div class="txt1">示例：</div>
            <div class="txt1 color">
              0000000,张三,13900000000,浙江省杭州市西湖区江南大道88号;
            </div>
            <div class="txt1">
              订单编号：淘、猫、京、拼等平台订单编号，如无订单编号可随机填写。
            </div>
            <div class="txt1">
            ...
            <div class="txt1">
              1、使用方式：从网站千牛卖家发货中心或京东商家中心跳转至云仓包裹下单并自动上传快递单号。
            </div>
            <div class="txt1">
              2、该批量发货方式需要先1、使用方式：从网站千牛卖家发货中心或京东商家中心跳转至云仓包裹下单并自动上传快递单号。2、该批量发货方式需要先
              <span class="colorspan">下载安装插件</span
              >（打开浏览器的扩展程序，然后在那里加载已解压的插件）查看视频教程
            </div>
        ...
        <div class="nav4">
          ...
          <div class="txt4">
            ...
            <div class="footer">
              <div @click="onSubmitTijiao" class="btn">
                确认订单￥{{ zongPrice }}
              </div>
              <div class="txt">
                总共 {{ peopleNum }} 个 收件人，每位价格 ￥ {{ shopPrice }}
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="box1">
            <div class="left">
              ...
              >
                ...
                <img
                  class="upLoadImg"
                  src="../../assets/newImg/lujin498.png"
                  alt=""
                />
            ...
            <div class="right">
              ...
              <div class="tit2">
                3、如果您对ExCel操作比较熟悉，可以下载后台订单，筛选后直接上传
              </div>
      ...
      <template v-if="radioVal2 == '智能筛选'">
        ...
        <div class="nav4">
          ...
          <div class="txt4">
            ...
            <div class="footer">
              <div @click="onSubmitZhineng" class="btn">
                确认订单￥{{ zongPrice }}
              </div>
              <div class="txt">
                总共 {{ peopleNum }} 个 收件人，每位价格 ￥ {{ shopPrice }}
      ...
      <template
        v-if="radioVal2 == '淘宝一键下单' || radioVal2 == '拼多多一键下单'"
      >
        <div class="nav3-tbyjxd">
          ...
          <div class="tit2">
            ...
            <div @click="ckdplbDialogVisible = true" class="bt1">
              查看店铺列表
            </div>
          </div>
          ...
          <div
            v-if="radioVal2 == '拼多多一键下单' && pddRadio == 'pddTime'"
            class="pddTimeInp"
          >
            <el-date-picker
              v-model="pddTimeArr"
          ...
          <div class="tit3">
            ...
            <div class="right">
              ...
              <div class="tit2">
                2、点击授权时，若没有跳转到授权页面，请重新授权
              </div>
              <div class="tit2">
                3、不支持淘宝一键下单的仓储：广州极兔仓、广州申通仓、华北顺丰仓
              </div>
            </div>
          </div>
          ...
          .then((res) => {
            ...
            if (res.data.code == 200) {
              ...
              this.strDataArr.forEach((ele,i) => {
                  this.znsxTextarea1Arr[i]+= `,${ele["1"]},${ele["2"]},${ele["3"]};\n`;
              });
