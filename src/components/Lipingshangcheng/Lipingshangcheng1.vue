<template>
  <div class="index">
    <!-- <div class="nav1">
      <div class="btn">
        <img src="../../assets/newImg/juxin57.png" class="pic1" alt="" />
        <img src="../../assets/newImg/lujin133.png" class="pic2" alt="" />
        <div class="tit1">所有礼品</div>
      </div>
      <img class="pic3" src="../../assets/newImg/zu67.png" alt="" />
      <div class="search">
        <el-input
          placeholder="请输入内容"
          v-model="searchVal"
        ...
        <div class="right">
          ...
          >
            ...
            <vxe-table-column :field="null" title="价格">
              <template #default="{ row }">
                <div class="formNav3">¥{{ row.price * addShopNum }}</div>
              </template>
            </vxe-table-column>
            ...
            <div class="r-nav3">
              ...
              <div v-if="tableData3[0]">
                ...
                <div class="nav1">
                  ...
                  <div class="txt3">
                    ¥{{ tableData3[0].price * addShopNum + kdyunfei }}
                  </div>
                </div>
              </div>
            </div>
